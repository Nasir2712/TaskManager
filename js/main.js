...
function getCategories(){
	$.get("https://api.mongolab.com/api/1/databases/task_manager/collections/categories?apiKey=" +api_key, function(data){
	var output = '<ul class="list-group">';
	$.each(data, function(key, data) {
...
function addTask(){
	...
	$.ajax({
		url:'https://api.mongolab.com/api/1/databases/task_manager/collections/tasks?apiKey='+ api_key,
		data: JSON.stringify({
			"task_name":task_name,
			"category":category,
			"due_date":due_date,
...
function getTask(){
	...
	$.get( 'https://api.mongolab.com/api/1/databases/task_manager/collections/tasks/'+task_id+'?apiKey='+ api_key, function(data) {
...
function editTask(){
	...
	$.ajax({url: 'https://api.mongolab.com/api/1/databases/task_manager/collections/tasks/'+task_id+'?apiKey=' + api_key,
		data: JSON.stringify({
		    "task_name" : task_name,
			"category": category,
			"due_date": due_date,
...
function deleteTask(){
	var task_id = $(this).data('task-id');
	$.ajax({ 
		url: 'https://api.mongolab.com/api/1/databases/task_manager/collections/tasks/'+task_id+'?apiKey=' + api_key,
		type: "DELETE",
		async: true,
		timeout: 300000,
		success: function (data) { 
...
function addCategory(){
	...
	$.ajax({
		url:'https://api.mongolab.com/api/1/databases/task_manager/collections/categories?apiKey='+ api_key,
		data: JSON.stringify({
...
function getCategory() {
	...
	$.get('https://api.mongolab.com/api/1/databases/task_manager/collections/categories/'+category_id+'?apiKey='+ api_key, function(data){
...
function editCategory(){
	...
	var category_name = $('#category_name').val();
	$.ajax({
		url:'https://api.mongolab.com/api/1/databases/task_manager/collections/categories/'+category_id+'?apiKey='+ api_key,
		data: JSON.stringify({
			"category_name": category_name
		}),
		type:"PUT",
